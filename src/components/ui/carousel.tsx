...
const CarouselNextBestSelling = React.forwardRef<
  HTMLButtonElement,
...
CarouselNextBestSelling.displayName = "CarouselNextBestSelling";

const CarouselPreviousBestSelling = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<typeof Button> & { font: NextFont }
>(({ className, variant = "ghost", size = "default", ...props }, ref) => {
...
CarouselPreviousBestSelling.displayName = "CarouselPreviousBestSelling";
