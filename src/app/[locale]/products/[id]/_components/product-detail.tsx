...
import AddToBagButton from "@/components/features/product/add-to-bag-button";
...
export default function ProductDetail({ product }: ProductDetailProps) {
  ...
  const originalPrice = selectedVariant?.priceDiscount
  ...
  // Get main image from selected variant or use product images
  ...
  const mainImage =
    displayImages[0] || product.coverImage || "/assets/images/product.png";

  // Ensure image path is valid - handle both full URLs and relative paths
  const imageSrc =
    mainImage &&
  ...
  // Get thumbnail image for a variant
  const getVariantThumbnail = (variant: ProductVariant) => {
    const thumbImage =
      variant.images?.[0] || product.coverImage || "/assets/images/product.png";
    return thumbImage.startsWith("/") ||
      thumbImage.startsWith("http") ||
      thumbImage.startsWith("https")
      ? thumbImage
      : `/assets/images/${thumbImage}`;
  };
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative w-full h-[80vh] min-h-[60vh] bg-gray-50 overflow-hidden">
        <Image
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {colorVariants.map((variant) => {
                    ...
                    const variantImage = getVariantThumbnail(variant);
            ...
            >
                  ...
                  <div className="space-y-2">
                    {selectedVariant && (
                      <>
                        ...
                        <p>
                          ...
                          {selectedVariant.soldCount} units
                        </p>
                      </>
                    )}
                    {product.ratingsAverage !== undefined && (
                      <p>
                        ...
                        {product.ratingsAverage.toFixed(1)} / 5.0 (
              ...
              >
                ...
                <AccordionContent className="text-sm text-gray-600 pb-4">
                  <p>
                    Please refer to the product care label for specific care
                    instructions. For best results, follow the recommended care
                    guidelines to maintain the quality and appearance of your
                    item.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-sm text-gray-600 pb-4">
                  <p>
                    ...
                    exceptional customer service. Your satisfaction is our
                    priority, and we stand behind the quality of every item we
                    offer.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Wed, Jan 14 - Thu, Jan 15 (Estimated)
                  </p>
                </div>
              </div>
